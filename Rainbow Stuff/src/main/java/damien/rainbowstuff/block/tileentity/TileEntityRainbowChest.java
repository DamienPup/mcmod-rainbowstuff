package damien.rainbowstuff.block.tileentity;
...
public class TileEntityRainbowChest extends TileEntityLockableLoot implements ITickable {
	...
	public String getGuiID() {
		return RainbowStuff.MODID + ":rainbow_chest";
	}
	...
	@Override
	public void update(){
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceLastSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0){
